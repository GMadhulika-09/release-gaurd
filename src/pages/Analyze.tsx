      ...
      if (matchedScenario) {
        ...
        const genericResult: DemoScenario = {
          ...
          blastRadius: {
            ...
            potentiallyAffected: riskLevel === "HIGH"
          ...
          dependencyData: {
            changedComponent: code?.includes("payment") || code?.includes("auth") ? "CustomComponent" : "CustomCode",
            callers: riskLevel === "HIGH"
              ? ["Checkout", "Subscription", "API"]
              : riskLevel === "MEDIUM"
              ? ["Login", "User"]
              : ["UI"],
            highImpactCallers: riskLevel === "HIGH"
              ? ["Checkout", "Subscription"]
              : riskLevel === "MEDIUM"
              ? ["Login"]
              : [],
            criticalPaths: riskLevel === "HIGH"
              ? ["Checkout", "Refund"]
              : riskLevel === "MEDIUM"
              ? ["Login"]
              : []
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {previousRelease
                            ? `${previousRelease.totalFiles || 0} files • ${previousRelease.size}`
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {currentRelease
                            ? `${currentRelease.totalFiles || 0} files • ${currentRelease.size}`
                            : "Select a file to view details"}
                        </p>
                      </div>
                    </div>
